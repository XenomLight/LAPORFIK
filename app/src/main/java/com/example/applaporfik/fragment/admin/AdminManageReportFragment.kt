...
class AdminManageReportFragment : Fragment() {
    ...
    private fun setupRecyclerView() {
        adapter = AdminManageReportAdapter { reportId ->
            // You can open chat fragment or show dialog here
            Toast.makeText(context, "Clicked report ID: $reportId", Toast.LENGTH_SHORT).show()
        }
        binding.recyclerViewAdminManage.apply {
            layoutManager = LinearLayoutManager(context)
            adapter = this@AdminManageReportFragment.adapter
        }
    }
